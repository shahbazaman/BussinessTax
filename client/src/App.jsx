...
import { ToastContainer } from 'react-toastify'; // Removed toast import if unused here
...
import Inventory from './pages/Inventory'; // <-- Added Inventory
import Accounts from './pages/Accounts';   // <-- Added Accounts (Matches your new backend route)
import Employees from './pages/Employees';

function App() {
  const [isAuthenticated, setIsAuthenticated] = useState(!!localStorage.getItem('token'));

  // Clean, combined useEffect for handling auth state changes across tabs/components
  useEffect(() => {
    const checkAuth = () => {
...
useEffect(() => {
  ...
  // Listen for the custom event from Login.jsx
  window.addEventListener('authChange', checkAuth);
